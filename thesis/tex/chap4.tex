...
Parsing messages follows the algorithm in Listing \ref{code:parse} (page \pageref{code:parse}), which also augments the founder's email-based graph with every email processed.
